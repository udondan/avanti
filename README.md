...
| `mode`         | No       | File permission mode. Accepts a quoted octal string (`"0755"`), a bare number (`755`), or a YAML octal literal (`0o755`). Mode-only changes (content unchanged) are detected by `diff` and applied by `pull`.                           |
