...
- **Release artifacts** — download release assets attached to a GitHub or GitLab release by tag, `$latest` (newest semver release), `$recent` (newest by date), or `/pattern/[flags]` (GitLab prefers `package`-type links; falls back to all links)
